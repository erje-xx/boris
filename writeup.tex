...
\frac{\partial P_{nn}}{\partial k_{\zeta}} &= 2 k_{\zeta} k_{n}^{-2} - 2 k_{\zeta}^3 k_{n}^{-4} - 4 k_{\zeta}^3 k_{n}^{-4} F_{n} B +  \\
&+ 4 k_{\zeta}^5 k_{n}^{-6} F_{n} B - k_{\zeta}^4 k_{n}^{-4} B \frac{\partial F_{n}}{\partial k_{\zeta}} \nonumber
\end{align}
